...
Type const tell the computer what kind of data it is, it labels, tell the type, fixed value while
Untyped const is just a raw value,no name, no typed declared in our code